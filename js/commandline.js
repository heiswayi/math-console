function CommandLineEditor (params) {
  ...
  // WAYI
  var exprdata = (params && params.exprdata) ? params.exprdata : [
        '1.2 / (2.3 + 0.7)',
        'a = 5.08 cm + 1 inch',
        'a to inch',
        'sin(45 deg) ^ 2',
  ...
  function create() {
    ...
    dom.input.setAttribute("id", "exprInput");
    ...
    dom.btnEval.setAttribute("id", "exprInputEval");
